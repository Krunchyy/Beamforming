...
public class Agent extends Model{
	...
	public String displayBuffer(int size)
	{
		...
		for(IModel model : getMap().keySet())
		{
			...
			result += (((Mobile)model).isBeamforming() ? "<span  style=\"color:#80BFFF\">[BEAMFORMING]</span> " : "") + "Name : "+ model.getTag() + " Size : "+ getMap().get(model).size() + " rang : "+ Distance.setDelta(this,  model)+"\n";
